...
public class Tigr extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tigr);
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Tigr.this, MainActivity.class);
        ...
        try {
            InputStream is = getAssets().open("tigr.txt"); // открываем файл
